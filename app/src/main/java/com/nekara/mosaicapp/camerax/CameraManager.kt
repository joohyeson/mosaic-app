package com.nekara.mosaicapp.camerax
...
import com.nekara.mosaicapp.mlkit.vision.object_detection.ObjectDetectionProcessor
import com.nekara.mosaicapp.mlkit.vision.text_recognition.TextRecognitionProcessor
...
class CameraManager(
    ...
    private fun selectAnalyzer(): ImageAnalysis.Analyzer {
        return when (analyzerVisionType) {
            ...
            VisionType.OCR -> TextRecognitionProcessor(context ,graphicOverlay)
        }
    }
